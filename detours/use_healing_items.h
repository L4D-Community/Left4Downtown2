...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnUseHealingItems->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "SurvivorBot::UseHealingItems") from the game conf
		virtual const char *GetSignatureName()
		{
			return "SurvivorBot::UseHealingItems";
		}
