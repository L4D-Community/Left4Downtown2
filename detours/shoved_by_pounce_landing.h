...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnShovedByPounceLanding->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorPlayer::OnShovedByPounceLanding") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorPlayer::OnShovedByPounceLanding";
		}
...
#endif //_INCLUDE_SOURCEMOD_DETOUR_SHOVED_BY_POUNCE_LANDING_H_
