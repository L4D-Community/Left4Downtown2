...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnSelectTankAttack->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CBaseAnimating::SelectWeightedSequence") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CBaseAnimating::SelectWeightedSequence";
		}
