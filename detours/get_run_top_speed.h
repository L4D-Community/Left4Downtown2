...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnGetRunTopSpeed->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorPlayer::GetRunTopSpeed") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorPlayer::GetRunTopSpeed";
		}
