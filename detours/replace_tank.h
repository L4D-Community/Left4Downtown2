...
#ifndef _INCLUDE_SOURCEMOD_DETOUR_REPLACE_TANK_H_
#define _INCLUDE_SOURCEMOD_DETOUR_REPLACE_TANK_H_
...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnReplaceTank->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "ZombieManager::ReplaceTank") from the game conf
		virtual const char *GetSignatureName()
		{
			return "ZombieManager::ReplaceTank";
		}
...
#endif //_INCLUDE_SOURCEMOD_DETOUR_REPLACE_TANK_H_
