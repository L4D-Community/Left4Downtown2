...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnGetMissionVersusBossSpawning->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CDirectorVersusMode::GetMissionVersusBossSpawning") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CDirectorVersusMode::GetMissionVersusBossSpawning";
		}
