...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnSendInRescueVehicle->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CDirectorScriptedEventManager::SendInRescueVehicle") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CDirectorScriptedEventManager::SendInRescueVehicle";
		}
...
#endif //_INCLUDE_SOURCEMOD_DETOUR_SendInRescueVehicle_H_
