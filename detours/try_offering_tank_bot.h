...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnTryOfferingTankBot->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CDirector::TryOfferingTankBot") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CDirector::TryOfferingTankBot";
		}
