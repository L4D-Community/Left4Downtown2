...
#ifndef _INCLUDE_SOURCEMOD_DETOUR_GET_SCRIPT_VALUE_STRING_H_
#define _INCLUDE_SOURCEMOD_DETOUR_GET_SCRIPT_VALUE_STRING_H_
...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnGetScriptValueString->GetFunctionCount() > 0);
		}
