...
#ifndef _INCLUDE_SOURCEMOD_DETOUR_FAST_GET_SURVIVOR_SET_H_
#define _INCLUDE_SOURCEMOD_DETOUR_FAST_GET_SURVIVOR_SET_H_
...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnFastGetSurvivorSet->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorGameRules::FastGetSurvivorSet") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorGameRules::FastGetSurvivorSet";
		}
