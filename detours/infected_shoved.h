...
class Infected;
typedef void * (Infected::*InfectedShovedFunc)(Infected*, int entity);

class Infected : public DetourTemplate<InfectedShovedFunc, Infected>
{
private: //note: implementation of DetourTemplate abstracts
	...
	{
		return &Infected::OnInfectedShoved;
	}
};
