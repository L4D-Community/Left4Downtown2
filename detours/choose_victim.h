...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnChooseVictim->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "BossZombiePlayerBot::ChooseVictim") from the game conf
		virtual const char *GetSignatureName()
		{
			return "BossZombiePlayerBot::ChooseVictim";
		}
