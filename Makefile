...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp natives.cpp vglobals.cpp util.cpp asm/asm.c player_slots.cpp \
			...
			detours/mob_rush_start.cpp detours/spawn_it_mob.cpp detours/try_offering_tank_bot.cpp \
			detours/get_script_value_int.cpp detours/shoved_by_survivor.cpp codepatch/patchmanager.cpp
