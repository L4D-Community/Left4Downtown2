...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp natives.cpp vglobals.cpp l4d2calls.cpp util.cpp asm/asm.c player_slots.cpp \
			...
			detours/get_run_top_speed.cpp detours/get_walk_top_speed.cpp detours/get_difficulty.cpp \
			detours/get_survivor_set.cpp detours/fast_get_survivor_set.cpp detours/get_mission_versus_boss_spawning.cpp \
