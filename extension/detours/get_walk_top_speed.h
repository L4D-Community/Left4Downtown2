...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnGetWalkTopSpeed->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorPlayer::GetWalkTopSpeed") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorPlayer::GetWalkTopSpeed";
		}
...
#endif //_INCLUDE_SOURCEMOD_DETOUR_GET_WALK_TOP_SPEED_H_
