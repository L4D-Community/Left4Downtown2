...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnCThrowActivate->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CThrow::ActivateAbililty") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CThrow::ActivateAbililty";
		}
...
#endif //_INCLUDE_SOURCEMOD_DETOUR_CTHROWACTIVATE_H_
