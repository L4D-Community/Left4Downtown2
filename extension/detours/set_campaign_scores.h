...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnSetCampaignScores->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorGameRules::SetCampaignScores") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorGameRules::SetCampaignScores";
		}
