...
namespace Detours
{
	...
	private: //note: implementation of DetourTemplate abstracts
		...
		{
			return (g_pFwdOnGetCrouchTopSpeed->GetFunctionCount() > 0);
		}

		// get the signature name (i.e. "CTerrorPlayer::GetCrouchTopSpeed") from the game conf
		virtual const char *GetSignatureName()
		{
			return "CTerrorPlayer::GetCrouchTopSpeed";
		}
